...
<body>
    ...
    <div class="glass-card">
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold title mb-2">Inmobiliaria</h1>
            <p class="text-white opacity-80">Datos Incorrectos</p>
        </div>
        
        <form id="form-login" action="/angeles/" method="post" class="space-y-6">
            <div class="flex items-center justify-between">
            <button type="submit" class="w-full btn-login font-medium">VOLVER</button>
        </form>
    </div>
